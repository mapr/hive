...
@RunWith(Parameterized.class) public class MapRSaslAuthDefaultTest {
  ...
  public MapRSaslAuthDefaultTest(String group, boolean isHs2AuthInHiveSite, boolean isHmsAuthInHiveSite,
  ...
  public static Collection configurations() {
    return Arrays.asList(new Object[][] {
        // hs2 auth = PAM on MapR SASL cluster
        ...
        // hs2 auth = LDAP on MapR SASL cluster
        ...
        // hs2 auth = MAPRSASL on MapR SASL cluster
        ...
        // hs2 auth = KERBEROS on MapR SASL cluster
        ...
        // hs2 auth = NONE on MapR SASL cluster
