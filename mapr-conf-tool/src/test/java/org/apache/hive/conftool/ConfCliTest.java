...
public class ConfCliTest {
  ...
  @Test public void restrictedListSecurityOnTest()
    ...
    Assert.assertEquals(
        "hive.security.authenticator.manager,hive.security.authorization.manager," + "hive.users.in.admin.role,"
            ...
            + "hive.semantic.analyzer.hook,hive.exec.driver.run.hooks," + "hive.server2.session.hook",
  ...
  @Test public void configureWebUiHs2PamSslSecurityOnTest()
    ...
    Assert.assertEquals("/opt/mapr/conf/ssl_keystore",
        ConfTool.getProperty(pathToHiveSite, "hive.server2.webui.keystore.path"));
    Assert.assertEquals(new String(new char[] { 'm', 'a', 'p', 'r', '1', '2', '3' }),
        ConfTool.getProperty(pathToHiveSite, "hive.server2.webui.keystore.password"));
  }
  ...
  @Test public void configureWebHCatSslSecurityOnTest()
    ...
    Assert.assertEquals("/opt/mapr/conf/ssl_keystore",
        ConfTool.getProperty(pathToWebHCatSite, "templeton.keystore.path"));
    Assert.assertEquals(new String(new char[] { 'm', 'a', 'p', 'r', '1', '2', '3' }),
        ConfTool.getProperty(pathToWebHCatSite, "templeton.keystore.password"));
  }
  ...
  @Test public void configureHs2SslSecurityOnTest()
    ...
    Assert.assertEquals("/opt/mapr/conf/ssl_keystore",
        ConfTool.getProperty(pathToHiveSite, "hive.server2.keystore.path"));
    Assert.assertEquals(new String(new char[] { 'm', 'a', 'p', 'r', '1', '2', '3' }),
        ConfTool.getProperty(pathToHiveSite, "hive.server2.keystore.password"));
  }
