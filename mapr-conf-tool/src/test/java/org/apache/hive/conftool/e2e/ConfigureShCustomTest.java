...
public class ConfigureShCustomTest extends ConfigureShBaseTest {

  @Override
  void initSecurity(String mapRConfPath) throws IOException {
    copyFromResources("custom-enabled" + I + "mapr-clusters.conf", mapRConfPath + I + "mapr-clusters.conf");
    copyFromResources("custom-enabled" + I + ".customSecure", mapRConfPath + I + ".customSecure");
  }

  @Override
  Map<String, String> afterInstallHiveSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "custom-hive-site-install.properties");
  }

  @Override
  Map<String, String> afterUpdateHiveSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "custom-hive-site-update.properties");
  }
  ...
  Map<String, String> afterUpdateWebHCatSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "custom-webhcat-site-update.properties");
  }
