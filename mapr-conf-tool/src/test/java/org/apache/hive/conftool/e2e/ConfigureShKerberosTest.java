...
public class ConfigureShKerberosTest extends ConfigureShBaseTest{

  @Override
  void initSecurity(String mapRConfPath) throws IOException {
    copyFromResources("krb-enabled" + I + "mapr-clusters.conf", mapRConfPath + I + "mapr-clusters.conf");
  }

  @Override
  Map<String, String> afterInstallHiveSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "kerberos-hive-site-install.properties");
  }

  @Override
  Map<String, String> afterUpdateHiveSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "kerberos-hive-site-update.properties");
  }

  @Override
  Map<String, String> afterInstallWebHCatSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "kerberos-webhcat-site-install.properties");
  }

  @Override
  Map<String, String> afterUpdateWebHCatSite() throws IOException {
    return readFrom("e2e" + I + "expected" + I + "kerberos-webhcat-site-update.properties");
  }
