...
public class CustomAuthDefaultTest {
  ...
  public static Collection configurations() {
    return Arrays.asList(new Object[][] {
        ...
        { "PAM", true, true, true, "PAM", "MAPRSASL", true }, { "PAM", true, true, false, "PAM", "MAPRSASL", false },
        { "PAM", true, false, true, "PAM", "MAPRSASL", true }, { "PAM", true, false, false, "PAM", "MAPRSASL", false },
  ...
  public void testDefaultConf() throws ParserConfigurationException, SAXException, IOException {
    String path = "default-conf/custom/" + buildHiveSiteName(group, isHs2AuthInHiveSite, isHmsAuthInHiveSite,
        isSaslEnabledInHiveSite);
