        ...
        case NAMES:
          if (field.type == NAMES_FIELD_DESC.type) {
            java.util.List<java.lang.String> names;
            {
              ...
              names = new java.util.ArrayList<java.lang.String>(_list498.size);
        ...
        case EXPRS:
          if (field.type == EXPRS_FIELD_DESC.type) {
            java.util.List<DropPartitionsExpr> exprs;
            {
              ...
              exprs = new java.util.ArrayList<DropPartitionsExpr>(_list501.size);
              @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem502;
    ...
    switch (setField_) {
      case NAMES:
        java.util.List<java.lang.String> names = (java.util.List<java.lang.String>)value_;
        {
          ...
          for (java.lang.String _iter504 : names)
          {
      ...
      switch (setField) {
        case NAMES:
          java.util.List<java.lang.String> names;
          {
            ...
            names = new java.util.ArrayList<java.lang.String>(_list506.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem507;
        ...
        case EXPRS:
          java.util.List<DropPartitionsExpr> exprs;
          {
            ...
            exprs = new java.util.ArrayList<DropPartitionsExpr>(_list509.size);
            @org.apache.thrift.annotation.Nullable DropPartitionsExpr _elem510;
  ...
  protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case NAMES:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, names.size()));
          for (java.lang.String _iter512 : names)
          {
