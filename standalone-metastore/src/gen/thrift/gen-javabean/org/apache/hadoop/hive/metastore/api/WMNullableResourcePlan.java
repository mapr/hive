...
public class WMNullableResourcePlan implements org.apache.thrift.TBase<WMNullableResourcePlan, WMNullableResourcePlan._Fields>, java.io.Serializable, Cloneable, Comparable<WMNullableResourcePlan> {
  ...
  public int compareTo(WMNullableResourcePlan other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsSetQueryParallelism()).compareTo(other.isSetIsSetQueryParallelism());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsSetQueryParallelism()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsSetDefaultPoolPath()).compareTo(other.isSetIsSetDefaultPoolPath());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsSetDefaultPoolPath()) {
