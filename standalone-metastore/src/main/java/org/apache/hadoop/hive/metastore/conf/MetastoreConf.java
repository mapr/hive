...
public class MetastoreConf {
  ...
  public enum ConfVars {
    ...
    SSL_PROTOCOL_BLACKLIST("metastore.ssl.protocol.blacklist", "hive.ssl.protocol.blacklist",
        "SSLv2,SSLv3,SSLv2Hello,TLSv1,TLSv1.1", "SSL Versions to disable for all Hive Servers"),
    SSL_PROTOCOL_VERSION("metastore.ssl.protocol.version", "hive.metastore.ssl.protocol.version" ,"TLSv1.2",
        "SSL protocol versions for metastore"),
