...
JAVA_OPTS_BASE="-server -Djava.net.preferIPv4Stack=true -XX:NewRatio=8 -XX:+UseNUMA -XX:+PrintGCDetails -verbose:gc -Xlog::::filecount=4,filesize=100M -Xlog:::time,level,tags"
