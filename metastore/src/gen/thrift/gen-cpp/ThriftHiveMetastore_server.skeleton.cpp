...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<ThriftHiveMetastoreHandler> handler(new ThriftHiveMetastoreHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new ThriftHiveMetastoreProcessor(handler));
