...
public class ShowLocksResponseElement implements org.apache.thrift.TBase<ShowLocksResponseElement, ShowLocksResponseElement._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksResponseElement> {
  ...
  public int compareTo(ShowLocksResponseElement other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLastheartbeat()).compareTo(other.isSetLastheartbeat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAcquiredat()).compareTo(other.isSetAcquiredat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAcquiredat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBlockedByExtId()).compareTo(other.isSetBlockedByExtId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockedByExtId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBlockedByIntId()).compareTo(other.isSetBlockedByIntId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockedByIntId()) {
