...
class TOpenSessionReq(object):
    ...
    def __init__(self, client_protocol=8, username=None, password=None, configuration=None,):
...
class TOpenSessionResp(object):
    ...
    def __init__(self, status=None, serverProtocolVersion=8, sessionHandle=None, configuration=None,):
        self.status = status
