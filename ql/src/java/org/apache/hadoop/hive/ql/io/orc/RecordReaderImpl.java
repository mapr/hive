  ...
  private static class ShortTreeReader extends TreeReader{
    ...
    void startStripe(Map<StreamName, InStream> streams,
      ...
      StreamName name = new StreamName(columnId,
          OrcProto.Stream.Kind.DATA);
      reader = createIntegerReader(stripeFooter.getColumnsList().get(columnId).getKind(), streams.get(name), true);
    }
  ...
  private static class BinaryTreeReader extends TreeReader{
    ...
    void startStripe(Map<StreamName, InStream> streams,
      ...
      StreamName name = new StreamName(columnId,
          OrcProto.Stream.Kind.DATA);
      stream = streams.get(name);
      lengths = createIntegerReader(stripeFooter.getColumnsList().get(columnId).getKind(), streams.get(new
  ...
  private static class DecimalTreeReader extends TreeReader{
    ...
    void startStripe(Map<StreamName, InStream> streams,
      ...
      valueStream = streams.get(new StreamName(columnId,
          OrcProto.Stream.Kind.DATA));
      scaleStream = createIntegerReader(stripeFooter.getColumnsList().get(columnId).getKind(), streams.get(
