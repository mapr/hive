...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TestGenericUDFToUtcTimestampNew.TestsWithParameters.class,
    TestGenericUDFToUtcTimestampNew.TestsWithoutParameters.class })
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] {
          ...
          { writableHiveVarcharObjectInspector, new HiveVarcharWritable(
              ...
              "Australia/Sydney", "1969-12-31 14:00:00.123456789" },
          { writableHiveVarcharObjectInspector, new HiveVarcharWritable(
              new HiveVarchar("2018-10-07 02:00:00.0", 55)), "Australia/Sydney",
              "2018-10-06 16:00:00.0" } });
    }
  ...
  public static class TestsWithoutParameters {
    ...
    public void testTimestamp() throws HiveException {
      ...
      DeferredJavaObject[] values = new DeferredJavaObject[] {
          new DeferredJavaObject(new TimestampWritable(
              Timestamp.valueOf("1970-01-01 00:00:00.0"))),
          new DeferredJavaObject(new Text("Australia/Sydney")) };
      GenericUDFToUtcTimestampNew udf = new GenericUDFToUtcTimestampNew();
      udf.initialize(objectInspectors);
      Object result = udf.evaluate(values);
      assertEquals("1969-12-31 14:00:00.0", result.toString());
    ...
    public void testDate() throws HiveException {
      ...
      ObjectInspector[] objectInspectors =
          new ObjectInspector[] { writableDateObjectInspector,
              writableStringObjectInspector };
      DeferredJavaObject[] values = new DeferredJavaObject[] {
          new DeferredJavaObject(new DateWritable(0)),
          new DeferredJavaObject(new Text("Australia/Sydney")) };
      GenericUDFToUtcTimestampNew udf = new GenericUDFToUtcTimestampNew();
      udf.initialize(objectInspectors);
      Object result = udf.evaluate(values);
