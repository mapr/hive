...
public class TestVectorStringExpressions {
  ...
  public void testStringLikeMultiByte() throws HiveException, UnsupportedEncodingException {
    ...
    batch = makeStringBatchMixedCharSize();
    expr = new FilterStringColLikeStringScalar(0, ('%' + new String(multiByte, StandardCharsets.UTF_8) + '%')
    ...
    batch = makeStringBatchMixedCharSize();
    expr = new FilterStringColLikeStringScalar(0, ('%' + new String(multiByte, StandardCharsets.UTF_8) + 'x')
        .getBytes(StandardCharsets.UTF_8));
    expr.evaluate(batch);
    Assert.assertEquals(0, batch.size);
  }
